...
class Arrays {
    ...
    /**
     * Converts an array into a Map of int keys and float values
     * @param mixed $array
     * @return array<int,float>
     */
    public static function toIntFloatMap(mixed $array): array {
        if (!is_array($array)) {
            return [];
        }
        ...
        $result = [];
        foreach ($array as $key => $value) {
            $result[Numbers::toInt($key)] = Numbers::toFloat($value);
        }
        return $result;
    }
